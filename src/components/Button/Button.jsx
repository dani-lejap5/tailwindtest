...
function Button({ label, variant = "secondary" }) {
    ...
    const base = "mt-auto w-fit rounded-xl px-6 py-3.5 text-base font-medium cursor-pointer border-none transition-colors duration-200";

    // Variant-specific colours — each class maps to a component token in index.css
    const variants = {
        secondary: "bg-btn-secondary text-text-primary rounded-lg hover:bg-btn-secondary-hover",
